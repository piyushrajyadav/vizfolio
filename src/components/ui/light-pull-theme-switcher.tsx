...
interface LightPullThemeSwitcherProps {
  compact?: boolean;
}

export function LightPullThemeSwitcher({ compact = false }: LightPullThemeSwitcherProps) {
      ...
      return (
        <div className="relative py-2 px-2 overflow-hidden">
          <motion.div
            ...
            className="relative bottom-0 w-6 h-6 rounded-full cursor-grab
                 ...
                 shadow-[0_0_15px_4px_rgba(250,204,21,0.3)] 
                 dark:shadow-[0_0_15px_4px_rgba(31,41,55,0.5)]"
            title="Pull down to toggle theme"
          >
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 w-0.5 h-32 bg-neutral-200 dark:bg-neutral-700"></div>
          </motion.div>
        </div>
      );
    }
