...
export function EnhancedHeroSection() {
    const title = "Start Building Your Portfolio";
        ...
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-white dark:bg-neutral-950">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
                ...
                >
                    ...
                    >
                        Create stunning portfolios with multiple themes. Perfect for freelancers, students, and professionals. Showcase your work and build your brand.
                    </motion.p>
                    ...
                    >
                        <p className="text-sm text-muted-foreground">
                            ✨ Pull down the theme switcher in navbar to toggle dark/light mode
                        </p>
                    </motion.div>
                </motion.div>
            </div>
